...
function NavList2({ carts }) {
  return (
    <div className="my-2 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      <div className="p-1 font-medium text-xl">
        <Link
          to={"/cart"}
          className="flex items-center hover:text-blue-500 text-blue-gray-900"
        >
          <SlHandbag />
          {carts.length}
        </Link>
      ...
      <div className=" font-extrabold text-4xl">
        <Link
          to={"/loggin"}
          className=" hover:text-blue-500 transition-colors text-blue-gray-900 "
        >
          <CiLogin />
        </Link>
      </div>
...
function NavList3({ carts, navigate, setIsLogged, userLogged }) {
  return (
    <div className="my-2 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      <div className="p-1 font-medium text-xl">
        <Link
...
function ProfileMenu({ navigate, setIsLogged, userLogged }) {
  const handleSignOut = () => {
    localStorage.clear();
    navigate("/loggin");
    setIsLogged(false);
  };
  if (userLogged.role == "a") {
    return (
      <Menu>
        <MenuHandler>
          <Avatar
...
const NavBar = ({
  ...
  if (isLogged == false) {
    return (
      <Navbar className=" max-w-screen-3xl  py-4 rounded-none bg-navColor border-none fixed z-10">
